...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/remote-cluster-sep22-20](https://github.com/rhdh-JslYoon-org/remote-cluster-sep22-20)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/remote-cluster-sep22-20-gitops](https://github.com/rhdh-JslYoon-org/remote-cluster-sep22-20-gitops)

# **Usage**

To access the remote-cluster-sep22-20 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of remote-cluster-sep22-20. You can access this namespace through the web console or via your CLI.
